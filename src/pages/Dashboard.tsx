      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { action: 'Novo orçamento criado', description: 'Orçamento #123 para reforma de cozinha', time: 'há 10 minutos' },
              { action: 'Visita agendada', description: 'Visita técnica para cliente João Silva', time: 'há 1 hora' },
              { action: 'Ordem de serviço emitida', description: 'OS #45 para instalação de ar condicionado', time: 'há 2 horas' },
              { action: 'Pagamento recebido', description: 'Recebimento de R$ 2.500,00 da OS #42', time: 'há 3 horas' },
            ].map((activity, index) => (
